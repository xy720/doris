...
public class BrokerUtilTest {
    ...
    @Test
    public void testReadBrokerFile(@Mocked TPaloBrokerService.Client client, @Mocked Catalog catalog,
        ...
        String readStr = BrokerUtil.readBrokerFile(filePath, brokerDesc);
        Assert.assertEquals(dppResultStr, readStr);
    }

    @Test
    public void testWriteBrokerFile(@Mocked TPaloBrokerService.Client client, @Mocked Catalog catalog,
                                    @Injectable BrokerMgr brokerMgr)
            throws TException, UserException, UnsupportedEncodingException {
        ...
        try {
            BrokerUtil.writeBrokerFile(configs, destFilePath, brokerDesc);
        } catch (Exception e) {
    ...
    @Test
    public void testDeleteBrokerPath(@Mocked TPaloBrokerService.Client client, @Mocked Catalog catalog,
        ...
        try {
            BrokerDesc brokerDesc = new BrokerDesc("broker0", Maps.newHashMap());
            BrokerUtil.deleteBrokerPath("hdfs://127.0.0.1:10000/doris/jobs/1/label6/9", brokerDesc);
        } catch (Exception e) {
            Assert.fail(e.getMessage());
        }
    }
