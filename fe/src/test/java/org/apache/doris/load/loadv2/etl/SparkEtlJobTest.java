...
public class SparkEtlJobTest {
    ...
    public void setUp() {
        ...
        table.addFileGroup(new EtlFileGroup(Lists.newArrayList("hdfs://127.0.0.1:10000/file"), Lists.newArrayList(),
        ...
        // others
        String outputFilePattern = "label0.%d.%d.%d.%d.%d.parquet";
        String label = "label0";
    ...
    public void testCheckConfigWithBitmapDictColumns() {
        ...
        table.fileGroups.get(0).columnMappings.put(
